<template>
    <div style="width:100%;min-height:99vh;background-color: #eee;">
        <div style="width: 1200px;margin:0 auto;padding:10px;background-color: #fff;">
            <div style="font-size:24px;font-weight:bolder;color:blue;text-shadow:0px 0px 20px #FC7402;text-align: center;">入门引导</div>
            <div class="artical">
            ...
            <div class="artical">
                <div class="artical-title">怎么使用 three.js</div>
                <div class="artical-body">
                    <p class="c-item">
            ...
            <div class="artical">
                ...
                <div class="artical-body">
                    <p class="a-item">
                        <a href="http://192.168.3.42:5173/projects/co2" target="_blank">二氧化碳设备</a>
                    </p>
                    <p class="a-item">
                        <a href="http://192.168.3.42:5173/projects/co2Second" target="_blank">建筑楼层</a>
                    </p>
                </div>
            </div>
            <div class="artical">
